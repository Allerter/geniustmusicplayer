...
DEEZER_ARL_TOKEN = '24f43286aa2364dde2a791cbf3abf82c8d8e71b2eeaf0f5e72a8ace9790bd9b7fa1e65298cb67b0f93e719a13a2f3d5ca063d7f1c0f49d48e67a880f2e36154ca09a62097fc0eb8287bcf5bfae5ee78cf0c490e95392ef0c14a4dd44daef6949'
...
def download(link, details, recursive_quality=None,
    ...
    try:
        url = f'https://e-cdns-proxy-{song_md5[0]}.dzcdn.net/mobile/1/{song_hash}'
        crypted_audio = request(url)
...
def get_download_info(isrc):
    url = f'https://api.deezer.com/track/isrc:{isrc}'
    datas = tracking(url)
    details = {"datas": datas, "quality": 'MP3_320'}
    ...
    ids = infos['SNG_ID']
    num_quality = qualities[quality]['n_quality']
    datas['file_format'] = qualities[quality]['f_format']
    datas['ids'] = ids
    try:
        song_md5 = infos['FALLBACK']['MD5_ORIGIN']
        version = infos['FALLBACK']['MEDIA_VERSION']
...
# bio = download_track(isrc='USWB12000270', output=BytesIO())
